...
Five names are in the code and not in 09's prose. session_closed, because 09 names the session
...
stops a role is the same class of event. An ordinary provider call is not here at all: its
