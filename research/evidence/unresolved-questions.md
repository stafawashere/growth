...
- sg-24 (2024 scoring guidelines): the prose of the scoring-note bullets is absent from the PDF text layer in both PyMuPDF and pdftotext output (page 4 has 50 vector drawings, no images, 919 characters). Only point labels, point values, and model-solution fragments survive. Resolved on 2026-09-19 by OCR: tools/ocr_pages.py (RapidOCR on 200 dpi renders) wrote cache/text/sg-24/page-NNN.ocr.txt for all 23 pages and the scoring-note prose is legible; 2024 point records and FRQ records were re-derived from the OCR layer, tagged [single-source] because OCR output is a machine transcription.
...
- Sample MCQ material: after OCR recovery (2026-09-19) 42 of 91 records were re-derived from the OCR layer and tagged [single-source]; the ced:221 key and the 2012 item 82 discrepancy are resolved; figures for 2012 items 15, 18, 78, 88 and sample items 7, 11 remain unrecoverable, and one table value behind CED item 13 differs between the OCR and primary layers (primary kept). No public College Board rationale exists for any distractor; every distractor mechanism in data/mcq_records.json is [inferred] or [uncertain].
- Archetype gaps recorded in FRQ record notes are now resolved. Ten archetypes were minted in block 99 (BC-QA-99001 to BC-QA-99010) and are catalogued in [../question-analysis/question-archetypes.md](../question-analysis/question-archetypes.md); the average value of a radial function along a polar curve was recorded as the variant BC-QV-08001-04 instead, because it keeps the invariant structure of BC-QA-08001. Four of the five point-type gaps are closed by BC-PT-99080 to BC-PT-99083 (quotient rule, partial fraction decomposition, slope and equation of a tangent line, slope field drawn at the indicated points). The fifth, a convergence conclusion supported by a named test, is covered by BC-PT-99072 and BC-PT-99046 and was not minted again. Expression points on 2013 Q2(b), 2013 Q2(c), and 2014 Q2(c) still have no exact point type.
...
- Misconception causal_prerequisites are now filled by derivation for 203 of the 213 active records, tagged [inferred] on each record and tabulated in [../misconceptions/misconception-taxonomy.md](../misconceptions/misconception-taxonomy.md). Ten cross-cutting block 99 records are linked from no skill and no archetype, so nothing could be derived and their lists stay empty.
